...
class GetFunctions {
    constructor(hapCharacteristic, platform) {
        ...
        this.getFunctionsMapping = new Map([
            ...
            [(new hapCharacteristic.TargetPosition()).UUID, { "function": this.getCurrentPosition, "delay": 0 }],
            ...
            [(new hapCharacteristic.LockTargetState()).UUID, { "function": this.getLockCurrentState, "delay": 2 }],
